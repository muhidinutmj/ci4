...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="/kran.jpg">
...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo">
                <a href="https://utmj.ac.id" target="_blank">
                    <img src="/kran.jpg" alt="logo" height="100">
                </a>
            </li>
    ...
    <div class="heroe">
        ...
        <marquee>Utm Jakarta - Keren</marquee>
